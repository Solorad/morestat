...
//    private OAuth2RestTemplate oAuth2RestTemplate;
    ...
    public String profile(Model model, HttpSession httpSession, OAuth2ClientContext oauth2ClientContext) {
        log.debug("In profile!");
        model.addAttribute(ACTIVE_TAB, "profile");
        model.addAttribute("userInfoData", httpSession.getAttribute(USER));
